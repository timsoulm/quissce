...
function MasterCtrl(e,o){var t=992;e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(g,n){g>=t?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.dads=[{name:"Greg Green",age:69,favoriteFood:"Pizza",hobby:"Baseball"},{name:"Sam Allen",age:58,favoriteFood:"Turkey",hobby:"Bikes"},{name:"Joe Levine",age:56,favoriteFood:"Corn",hobby:"Websites"}],e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
