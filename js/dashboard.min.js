...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/"),e.state("index",{url:"/",templateUrl:"templates/home.html"}).state("database",{url:"/database",templateUrl:"templates/database.html"}).state("about",{url:"/about",templateUrl:"templates/about.html"}).state("dadentry",{url:"/dadentry",templateUrl:"templates/dadentry.html"}).state("soupreviews",{url:"/soupreviews",templateUrl:"templates/soupreviews.html"}).state("careers",{url:"/careers",templateUrl:"templates/careers.html"}).state("reviewpage",{url:"/reviewpage",templateUrl:"templates/reviewpage.html"})}]);
...
function MasterCtrl(t,e,o,n){var s=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(e,n){e>=s?angular.isDefined(o.get("toggle"))?t.toggle=!!o.get("toggle"):t.toggle=!0:t.toggle=!1}),t.search={},t.searchSoup={},t.formData={},t.dads=[];var a=new Firebase("https://quissce.firebaseio.com/soups");t.soupReviews=n(a),e.get("../dads.json?_="+(new Date).getTime()).then(function(e){t.dads=e.data},function(t){console.log(t)}),t.submit=function(){e.post("https://s5events.azure-automation.net/webhooks?token=0dOuk0WKm0iCFbH0NRBhALJG3yLVWcwm1ghKYEvKpIE%3d",t.formData).success(function(t,e){console.log(e)})},t.setSoup=function(e){t.currentSoup=e},t.toggleSidebar=function(){t.toggle=!t.toggle,o.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$http","$cookieStore","$firebaseArray",MasterCtrl]);
