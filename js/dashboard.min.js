...
function MasterCtrl(t,o,e){var n=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(o,g){o>=n?angular.isDefined(e.get("toggle"))?t.toggle=!!e.get("toggle"):t.toggle=!0:t.toggle=!1}),t.search={},t.formData={},t.dads=[],o.get("../dads.json").then(function(o){t.dads=o.data,console.log(o.data)},function(t){console.log(t)}),t.submit=function(){o.post("https://s5events.azure-automation.net/webhooks?token=0dOuk0WKm0iCFbH0NRBhALJG3yLVWcwm1ghKYEvKpIE%3d",t.formData).success(function(t,o){console.log(o)})},t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$http","$cookieStore",MasterCtrl]);
